...
@Composable
fun onbording2(onbordingdata: onbordingdata, modifier: Modifier = Modifier,onclickback:()->Unit,onclicknext:()->Unit){
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Row (horizontalArrangement = Arrangement.SpaceBetween, modifier = Modifier.fillMaxWidth().padding(horizontal = 15.dp, vertical = 10.dp)){
            circularandicator(background1 = Color.LightGray, background2 = Color.Blue, background3 = Color.LightGray)
